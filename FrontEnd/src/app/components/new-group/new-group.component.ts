...
export class NewGroupComponent implements OnInit {
  ...
  constructor(public _user:UserService,private _snackBar: MatSnackBar, public _group:GroupService, public auth: AuthService, public router:Router) {
  ...
  createGroup(){
    if (this.newGroup.group_name != '') {
      this._group.postGroup(this.newGroup).subscribe(null,null,()=>{
